...
/// </summary>
/// <description>
/// This class adds a Edit > Scene Autoload menu containing options to select
...
static class SceneAutoLoader {
	...
	[MenuItem ("Edit/Scene Autoload/Select Master Scene...")]
	...
	[MenuItem ("Edit/Scene Autoload/Load Master On Play", true)]
	private static bool ShowLoadMasterOnPlay () {
		return !LoadMasterOnPlay;
	}
	[MenuItem ("Edit/Scene Autoload/Load Master On Play")]
	private static void EnableLoadMasterOnPlay () {
		LoadMasterOnPlay = true;
	}

	[MenuItem ("Edit/Scene Autoload/Don't Load Master On Play", true)]
	private static bool ShowDontLoadMasterOnPlay () {
		return LoadMasterOnPlay;
	}
	[MenuItem ("Edit/Scene Autoload/Don't Load Master On Play")]
